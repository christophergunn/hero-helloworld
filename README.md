...
launch from the command line:
    ...
    $ lein run -m hero-helloworld.web
...
get the app created:
    ...
    $ heroku apps:create hero-helloworld
    Creating hero-helloworld... done, stack is cedar
    http://hero-helloworld.herokuapp.com/ | git@heroku.com:hero-helloworld.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://hero-helloworld.herokuapp.com deployed to Heroku

    To git@heroku.com:hero-helloworld.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://hero-helloworld.herokuap.com
    ["Hello" :from Heroku]
